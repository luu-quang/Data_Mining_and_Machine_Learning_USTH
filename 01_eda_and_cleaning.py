...
# Execute Pipeline
train_df = pd.read_parquet(r"C:\ML2_final_project\train_optimized.parquet")
train_df, m_renta, m_age = process_data(train_df, "TRAINING DATA")

test_df = pd.read_parquet(r"C:\ML2_final_project\test_optimized.parquet")
test_df, _, _ = process_data(test_df, "TESTING DATA", m_renta, m_age)

train_df.to_parquet(r"C:\ML2_final_project\train_cleaned.parquet", engine='pyarrow')
test_df.to_parquet(r"C:\ML2_final_project\test_cleaned.parquet", engine='pyarrow')
